...
def yolo():
    ...
    #dataset_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'yolov5_master/data/images')
    #dataset = LoadImages(dataset_path, img_size=imgsz, stride=stride, auto=pt, vid_stride=vid_stride)
